...
namespace ToolGood.Infrastructure
{
    public static class Hash
    {
        ...
        #region MD5
        public static string GetMd5String(Stream buffer)
        {
            if (buffer == null) throw new ArgumentNullException("buffer");
        ...
        public static byte[] GetMd5Bytes(Stream buffer)
        {
            if (buffer == null) throw new ArgumentNullException("buffer");
        ...
        #region SHA1
        public static string GetSha1String(Stream buffer)
        {
            if (buffer == null) throw new ArgumentNullException("buffer");
        ...
        public static byte[] GetSha1Bytes(Stream buffer)
        {
            if (buffer == null) throw new ArgumentNullException("buffer");
        ...
        public static string GetSha256String(Stream buffer)
        {
            if (buffer == null) throw new ArgumentNullException("buffer");
        ...
        public static byte[] GetSha256Bytes(Stream buffer)
        {
            if (buffer == null) throw new ArgumentNullException("buffer");
        ...
        #region SHA384
        public static string GetSha384String(Stream buffer)
        {
            if (buffer == null) throw new ArgumentNullException("buffer");

            SHA384 sha384 = new SHA384Managed();
            byte[] retVal = sha384.ComputeHash(buffer); //计算指定Stream 对象的哈希值
            sha384.Dispose();
            return BitConverter.ToString(retVal).Replace("-", "");
        }
        ...
        public static byte[] GetSha384Bytes(Stream buffer)
        {
            if (buffer == null) throw new ArgumentNullException("buffer");
        ...
        #region SHA512
        public static string GetSha512String(Stream buffer)
        {
            if (buffer == null) throw new ArgumentNullException("buffer");
        ...
        public static byte[] GetSha512Bytes(Stream buffer)
        {
            if (buffer == null) throw new ArgumentNullException("buffer");
