        ...
        view = {
            ...
            asyncNode: function (setting, node, isSilent, callback) {
                ...
                if (AntiforgeryToken != undefined) {
                    setting.async.headers["__RequestVerificationToken"] = AntiforgeryToken;
                }
                ...
                $.ajax({
                    ...
                    success: function (msg) {
                        ...
                        if (msg.ciphertext != undefined && msg.ciphertext.length > 2) {
                            msg = $.decrypt(msg.ciphertext, tools.apply(setting.async.url, [setting.treeId, node], setting.async.url));
                        }
